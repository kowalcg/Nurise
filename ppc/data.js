...
window.PPC_DATA = {
  ...
  account: {
    ...
    spendSub: "≈ $64/day across 14 active campaigns", clicksSub: "18 campaigns total"
  },
  ...
  actions: [
    ...
    {done: true, text: "<strong>6 zero-sale campaigns paused</strong> — they were burning ~$34/day (≈$1,000/month now saved) — done Aug 13."},
  ...
  notes: [
    "🏆 Win of the week: the Aug 13 pause of the 6 zero-sale campaigns — they spent $167.97 during Aug 9–12 alone. That waste stops now.",
